 ...
 * @next: A ptr to front of node_List
 */
 ...
 * The key is unique_in_HashTable
 * @value: The val corres to a key
 * @next: A pointer to front of  node_List
 * @sprev: A pointer to lst 
 * @snext: A pointer to 1st elementt
 */
 ...
 * @size: size
 * @array: An array
 * @shead: A pointer to the 1st element in linked list
 * @stail: A pointr to the last element
 */
